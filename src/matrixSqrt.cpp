...
//' Serially compute the square root of matrix elements
//'
//' @param orig A matrix
//'
...
//' Compute in parallel the square root of matrix elements
//'
//' @param orig A matrix
//'
//' @returns A matrix in which each element is the square root of the corresponding element in the original matrix
...
stopifnot(all.equal(matrixSqrt(m), parallelMatrixSqrt(m)))

# compare performance of serial and parallel
library(microbenchmark)
microbenchmark(matrixSqrt(m),
               parallelMatrixSqrt(m))
*/
